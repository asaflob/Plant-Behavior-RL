...
def compare_real_vs_agent():
    ...
    model_path = "q_agent_soil_w5_t2_h10_actions_10.pkl"  # <--- עדכן לשם הקובץ שיצרת
...
def analyze_experiment_prediction():
    ...
    # 1. הגדרות וטעינה
    # ==========================================
    model_file = "q_agent_sand_w5_t2_h10_actions_10.pkl"
    data_file = os.path.join("data", "tomato_mdp_ready_with_temp_humidity.parquet")
